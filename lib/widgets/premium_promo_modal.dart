          ...
          child: ClipRRect(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Bonus altın + ekstra güçlendirici + sınırsız can.\nSeçimini yap, kaldığın yerden devam et.',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'VIP Üyelik aylık olarak otomatik yenilenir (\$4.99/ay); mevcut dönem bitmeden 24 saat önce iptal etmezsen aynı tutar tahsil edilir. Hesap ayarlarından istediğin zaman iptal edebilirsin.',
            style: TT.bodySmall.copyWith(
              color: TT.driftWoodDark,
              fontSize: 9.5,
              height: 1.3,
